...
class MySQL
{
	...
	private $db_host    = "localhost"; // server name
        ...
        private $db_dbname  = "colegio";     // database name
	...
	*/
	 ...
	 */
	/**
	 * Returns a SQL safe value
	 *
	 * @param mixed $value The value to make safe
	 * @param string $datatype (Optional) The datatype of the value
	 * @return string Returns a SQL safe value
	 */
	public function GetSQLValue($value, $datatype = self::SQLVALUE_TEXT) {
		$return_value = "";
	...
	/**
	 * [STATIC] Returns a SQL safe value
	 *
	 * @param mixed $value The value to make safe
	 * @param string $datatype (Optional) The datatype of the value
	 * @return string Returns a SQL safe value
