...
$esContabilidad = isset($_SESSION['codTipoUsuario']) && (int)$_SESSION['codTipoUsuario'] === 6;
?>
<!-- ======= Sidebar ======= -->
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <?php if(!$esContabilidad && ($_SESSION['codTipoUsuario'] == 1 || $_SESSION['codTipoUsuario'] == 3 || $_SESSION['codTipoUsuario'] == 5)){ ?>
      <li class="nav-item">
    ...
    <?php if(!$esContabilidad && ($_SESSION['codTipoUsuario'] == 1 ||  $_SESSION['codTipoUsuario'] == 2 || $_SESSION['codTipoUsuario'] == 4)){ ?>
      <li class="nav-item">
    ...
    <?php if($_SESSION['codTipoUsuario'] == 1 || $_SESSION['codTipoUsuario'] == 3 || $_SESSION['codTipoUsuario'] == 6){ ?>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed  <?php if (strtolower($nombredelarchivo) == '../conceptosEgresos/') { echo 'active';}  ?>" href="../conceptosEgresos/">
       <i class="bi bi-card-checklist"></i>
          <span>Conceptos de Egresos</span>
        </a>
      </li>
      <li class="nav-item">
