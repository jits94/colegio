        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    ...
                    <div class="col-md-6 mt-2"><label>Gestión de Cobro</label><input type="number" id="txtGestion"
                    ...
                    <div class="col-md-12 mt-2"><label>Concepto</label><input type="text" id="txtConcepto"
                            class="form-control shadow-lg" value="Mensualidad Escolar"></div>
                </div>
