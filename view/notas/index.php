            ...
            <div class="card-body">
               <div class="row">
                    ...
                    <div class="col-md-3 mt-2">
                      ...
                      <div class="col-md-3 mt-2">
                        <label for="form-label">Trimestre</label>
                        <select  id="txtTrimestreFiltro" class="form-select shadow-lg" >
  ...
  <script>
    ...
    function mostrarFilaSaber(){
      ...
      function editarDatos(id,codCurso,codProfesor,nombres,apellidos){
       ...
       function traerCursosHabilitados(){
         ...
         // $("#divResultado").html('<div class="loading"> <center><i class="fa fa-spinner fa-pulse fa-5x" style="color:#3c8dbc"></i><br/>Cargando ...</center></div>');
          $.ajax({
              url: "../../respuestaParcial.php?operacion=traerCursosHabilitadosNotas",
              type: "POST",        
              data: {
                codProfesor:codProfesor 
      ...
      function filtrar(){
          ...
          if(trimestre == ""){
             swal("Oops!!","Debe seleccionar un trimestre", {
                      icon: "warning",
          ...
          $("#divResultado").html('<div class="loading"> <center><i class="fa fa-spinner fa-pulse fa-5x" style="color:#3c8dbc"></i><br/>Cargando ...</center></div>');
          $.ajax({
              url: "../../respuestaParcial.php?operacion=traerNotas",
              type: "POST",        
              data: {
                codProfesor:codProfesor,
                codCurso:codCurso,
